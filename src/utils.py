...
def upload_to_gcs(source_file_name,
    ...
    try:
        ...
        upload_folder_to_gcs(source_file_name, destination_blob_name, bucket_name)
    ...
    try:
        ...
        for root, _, files in os.walk(source_folder_name):
            for file_name in files:
                ...
                print(f"File '{file_path}' successfully uploaded to '{destination_blob_name}' in bucket '{bucket_name}'.")

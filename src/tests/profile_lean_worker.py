...
app = modal.App("profile lean_worker")
...
# run with `modal run --detach lean_worker.py`
# If this doesn't work because of "modal is not recognized" errors, try `python -m modal run --detach lean_worker.py`
